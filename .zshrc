...
export PATH=/opt/:/home/yurik/.local/share/JetBrains/Toolbox/scripts:$HOME/.local/bin:$HOME/.cargo/bin:$HOME/bin:/usr/local/bin:$PATH
...
alias gfi="git config core.fileMode false"
...
export XDG_DATA_DIRS="$XDG_DATA_DIRS:/var/lib/flatpak/exports/share:/home/yurik/.local/share/flatpak/exports/share"
alias ls="exa -l"
alias cat="batcat"
alias tb='tail -n +1 -f "$@" | batcat --paging=never'
alias batlog='tail -n +1 -f "$@" | batcat --style=grid --paging=never -l log'
alias catl="batcat --plain --paging=never"
